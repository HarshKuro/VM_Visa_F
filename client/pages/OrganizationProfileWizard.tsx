    ...
    <div className="mb-8">
            ...
            <div key={index} className="flex flex-col items-center flex-1">
              <div className="flex items-center w-full">
                <div
                  className={`w-12 h-12 rounded-full flex items-center justify-center border-2 transition-all duration-300 ${
                    isCompleted
                      ? "bg-vm-green border-vm-green text-white"
                      : isActive
                        ? "bg-vm-green border-vm-green text-white"
                        : "bg-white border-vm-gray-300 text-vm-gray-500"
                  }`}
                >
                  {isCompleted ? (
              ...
              <span
                className={`mt-2 text-sm font-medium transition-colors duration-300 ${
                  isActive ? "text-vm-green" : "text-vm-gray-600"
                }`}
              >
                {title}
              </span>
      ...
      <div className="mb-4">
        <div className="flex items-center justify-between text-sm">
          <span className="font-medium text-vm-gray-700">Progress</span>
          <span className="text-vm-gray-500">
